  ...
  data() {
    return {
      ...
      courses: [
        ...
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '英語演習IA'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '英会話IA'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '英語演習IB'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '英会話IB'},
        { year: 4, dept: 'J', category: '選択', credits: 2, checked: false, name: '哲学A'},
        { year: 4, dept: 'J', category: '選択', credits: 2, checked: false, name: '経済学A'},
        { year: 4, dept: 'J', category: '選択', credits: 2, checked: false, name: '社会学A'},
        { year: 4, dept: 'J', category: '選択', credits: 2, checked: false, name: '哲学B'},
        { year: 4, dept: 'J', category: '選択', credits: 2, checked: false, name: '経済学B'},
        { year: 4, dept: 'J', category: '選択', credits: 2, checked: false, name: '社会学B'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: 'ドイツ語IIA'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '中国語IA'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: 'ドイツ語IIB'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '中国語IB'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '日本文化論'},
        ...
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: 'プログラミング言語I'},
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: 'プログラミング言語II'},
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: '言語処理系I'},
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: '言語処理系II'},
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: 'オペ―レーティングシステムI'},
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: 'オペレーティングシステムII'},
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: '計算機インターフェースI'},
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: '計算機インターフェースII'},
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: '情報セキュリティI'},
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: '情報セキュリティII'},
        ...
        { year: 4, dept: 'J', category: '必修', credits: 2, checked: false, name: '課題研究'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '応用数学A'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '応用数学B'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '統計学'},
        { year: 4, dept: 'J', category: '選択', credits: 1, checked: false, name: '学外実習(インターン)'},
        { year: 5, dept: 'J', category: '必修', credits: 1, checked: false, name: '体育III'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '英語演習II'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '英会話II'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '国文学'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '心理学'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '法学'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: 'ドイツ語IIIA'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '中国語IIA'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: 'ドイツ語IIIB'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '中国語IIB'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '日本文化論'},
        { year: 5, dept: 'J', category: '必修', credits: 2, checked: false, name: '数値計算'},
        { year: 5, dept: 'J', category: '必修', credits: 2, checked: false, name: 'ソフトウェア設計I'},
        { year: 5, dept: 'J', category: '必修', credits: 2, checked: false, name: 'ソフトウェア設計II'},
        ...
        { year: 5, dept: 'J', category: '必修', credits: 2, checked: false, name: 'ネットワークシステムI'},
        { year: 5, dept: 'J', category: '必修', credits: 2, checked: false, name: 'ネットワークシステムII'},
        { year: 5, dept: 'J', category: '必修', credits: 8, checked: false, name: '卒業研究'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '画像情報システム'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '知能システム'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '制御情報システム'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '分散情報システム'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '信号処理工学'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '認知科学'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: 'データマイニング'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: 'バイオインフォマティクス'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: 'メディアデザイン'},
        { year: 5, dept: 'J', category: '選択', credits: 1, checked: false, name: '計測システム'},

        //C科
        { year: 1, dept: 'C', category: '必修', credits: 1, checked: false, name: '英語(G)A'},
        { year: 1, dept: 'C', category: '必修', credits: 1, checked: false, name: ''},
        { year: 1, dept: 'C', category: '必修', credits: 1, checked: false, name: ''},
        { year: 1, dept: 'C', category: '必修', credits: 1, checked: false, name: ''},
        { year: 1, dept: 'C', category: '必修', credits: 1, checked: false, name: ''},
        { year: 1, dept: 'C', category: '必修', credits: 1, checked: false, name: ''},
